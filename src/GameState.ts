...
export class GameState {
        ...
        constructor(public board:BoardState.Board,public currentPlayerID:number) {
        }
}
export function cloneGameState(gameState:GameState) {
        var out = new GameState(gameState.board,gameState.currentPlayerID);
...
export function getNextPlayer(gamestate:GameState):number{
      ...
      var out;
        ...
        //get current player index and then increase it by one and set the global player to this calculated player
                      ...
                      return gamestate.players[next].id;//Moves to next player
